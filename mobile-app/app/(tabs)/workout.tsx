...
const styles = StyleSheet.create({
  ...
  subLabel: { fontSize: 11, color: '#9ca3af', marginBottom: 4, fontWeight: '500' },
  input: {
  ...
  difText: { fontSize: 12, color: '#374151', fontWeight: '600' },
  ...
  ejPreviewText: { fontSize: 13, color: '#374151', flex: 1, fontWeight: '500' },
