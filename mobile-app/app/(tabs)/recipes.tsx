...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', elevation: 2, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8 },
  cardImage: { width: '100%', height: 160 },
  cardImagePlaceholder: { backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center' },
  cardBody: { padding: 14 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 },
  catChip: { backgroundColor: '#fff7ed', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  catChipText: { color: '#e26a07', fontSize: 11, fontWeight: '700' },
  deleteBtn: { padding: 4 },
  deleteBtnText: { fontSize: 16 },
  cardTitle: { fontSize: 16, fontWeight: '800', color: '#111827', marginBottom: 4 },
  cardCal: { fontSize: 13, color: '#6b7280', marginBottom: 8, fontWeight: '500' },
  expandBtn: { alignSelf: 'flex-start' },
  expandBtnText: { color: '#e26a07', fontSize: 12, fontWeight: '700' },
  ingredientesList: { marginTop: 8, gap: 3 },
  ingredienteItem: { fontSize: 13, color: '#374151', lineHeight: 20 },
  ...
  ingChipText: { color: '#374151', fontSize: 13, flex: 1, fontWeight: '500' },
